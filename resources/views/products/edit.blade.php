    ...
    <div class="container mx-auto mt-8">
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $product->name) }}" class="mt-1 p-2 w-full border rounded-md">
                @error('name')
            ...
            <div class="mb-4">
                ...
                <textarea name="product_detail" id="product_detail" class="mt-1 p-2 w-full border rounded-md">{{ old('product_detail', $product->product_detail) }}</textarea>
